...
<div class="breadcrumb">
    ...
    <a href="{{ route('payments.index') }}" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Payment</a>
    <a href="{{ route('payments.order', [$payment->id]) }}" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Order</a>
