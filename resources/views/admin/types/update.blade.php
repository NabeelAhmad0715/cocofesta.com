                ...
                <form action="{{ route('types.update',$type->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label style="display: block;"
                            class="font-weight-semibold @error('feature_image') text-danger @enderror">Featured Image </label>
                        ...
                        <div style="display:block;">
                            ...
                            <button type="button" id="featured" class="btn btn-primary btn-md trigger-image-utility" data-type="single" data-id="{{$type->id}}" data-target="featured-images" data-content="{{$featuredImage}}" data-postid="{{$type->id}}"  data-class="App\Type">Update Featured Image </button>
                        </div>
                        <span class="form-text text-muted">Accepted formats: svg, jpeg, png, jpg.</span>
                        @error('feature_image')
                        <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label style="display: block;"
                            class="font-weight-semibold @error('header_image') text-danger @enderror">Header Image</label>
                        ...
                        @endforelse
                        <div style="display:block;">
                            <input type="text" style="display:none;" name="header_image" value="{{ $headerImages }}" class="header-images" id="header-images">
                            <button type="button" id="header" class="btn btn-primary btn-md trigger-image-utility" data-content="{{$headerImages}}" data-target="header-images" data-postid="{{$type->id}}"  data-class="App\Type">Update Header Image</button>
                        </div>
                    ...
                    <div id="fields" class="row meta-data meta-data-form-group" style="margin-bottom:20px;">
                        ...
                        <div class="col-md-4" style="margin-bottom:20px">
                            <div class="form-group">
                                <label class="font-weight-semibold">HTML field label
                                </label>
                        ...
                        <div class="col-md-4" style="margin-bottom:20px">
                            <div class="form-group">
                                <label class=" font-weight-semibold">Field
                                    type</label>
                    ...
                    <fieldset class="mb-3">
                        ...
                        <div class="form-group">
                            <label class="font-weight-semibold @error('meta_title') text-danger @enderror">Meta Title</label>
                            <div class="form-group-feedback form-group-feedback-right">
                        ...
                        <div class="form-group">
                            <label class="font-weight-semibold @error('meta_keywords') text-danger @enderror">Meta
                                Keywords</label>
                            <div class="form-group-feedback form-group-feedback-right">
                        ...
                        <div class="form-group">
                            <label class="font-weight-semibold @error('meta_description') text-danger @enderror">Meta
                                Description</label>
                            <div class="form-group-feedback form-group-feedback-right">
