            ...
            <div class="card-body">
                <form action="{{ route('posts.update',[$type->slug,$post->id]) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <label
                            class="font-weight-semibold @error('{{ $field->label_name }}') text-danger @enderror">{{ $field->label_name }}
                    ...
                    <div class="form-group">
                        <label>Tags:</label>
                        <input type="text" id="tags" name="tags" class="form-control tag" value="{{$tags}}">
                    </div>
